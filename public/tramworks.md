...
tags:
  - 一人アドベントカレンダー
private: false
updated_at: '2025-12-12T00:01:17+09:00'
...
# モデリング
## 建物
作中のマップに配置されている建物です。自分はこれのコミットが一番多いと思います。超点数は300~1800ほど。だいたい窓わくが多いと超点数が爆発的に増えます。テクスチャで描ければ削減できるのですが、時間との兼ね合いでなかなか難しいところです。
...
![03](https://raw.githubusercontent.com/henohenon/qiita/refs/heads/main/images/tramcity/building07.png)
...
合計30個前後製作しているかと思います。全然全体で見たら1割行くか行かないかぐらいの量ではあります。モデラーたちのパワーがすごいです。
## 3000形
...
せっかくなので今ゲーム内で見れない、外装を剥がした姿や横からなど。車内も解像度高くテクスチャ貼ってあります。ちなみに納品時データの超点数は7386でした。
...
申し訳ないことに色々あって最近コミットがおろそかになりがちだったので、気を引き締めてまたコミットしていきたい〜！！
